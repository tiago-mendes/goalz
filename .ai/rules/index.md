...
| --- | --- |
| app/Actions/SaveGoalAccountAllocation.php, app/Actions/*Budget.php | .ai/rules/actions.md |
...
| {app/Models/Goal.php,resources/views/pages/goals/index.blade.php,tests/Feature/SharedGoalsTest.php}, {app/Models/Goal.php,resources/views/pages/goals/{index,allocations}.blade.php,tests/Feature/GoalRewardsTest.php} | .ai/rules/goals-feature.md |
| {app/{Actions,Models}/**/*Goal*,resources/views/{components/goal-achievement-celebration.blade.php,pages/goals/**},database/migrations/*goal_milestone*,tests/Feature/GoalRewards*} | .ai/rules/goals-migrations-feature.md |
...
| {resources/views/pages/goals/allocations.blade.php,tests/Feature/GoalRewardsTest.php} | .ai/rules/pages-goals-feature.md |
